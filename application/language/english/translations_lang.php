...
$lang['service_and_provider'] = 'Neighbourhood & Volunteer';
$lang['select_service'] = 'Select Neighbourhoods';
$lang['select_provider'] = 'Select Volunteer';
...
$lang['service'] = 'Neighbourhoods';
$lang['provider'] = 'Volunteer';
...
$lang['manage_appointment_record_hint'] = 'Manage all the appointment records of the available volunteers and neighbourhoods.';
$lang['select_filter_item_hint'] = 'Select a volunteer or a neighbourhood and view the appointments on the calendar.';
$lang['enable_appointment_sync_hint'] = 'Enable appointment synchronization with volunteer\'s Google Calendar account.';
$lang['manage_customers_hint'] = 'Manage the registered participants and view their booking history.';
$lang['manage_services_hint'] = 'Manage the available neighbourhoods and categories of the system.';
$lang['manage_users_hint'] = 'Manage the backend users (admins, volunteers, secretaries).';
$lang['settings_hint'] = 'Set system and user settings.';
$lang['log_out_hint'] = 'Log out of the system.';
$lang['unavailable_periods_hint'] = 'During unavailable periods the volunteer won\'t accept new appointments.';
...
$lang['customers'] = 'Participants';
$lang['details'] = 'Details';
$lang['no_records_found'] = 'No records found...';
$lang['services'] = 'Neighbourhoods';
...
$lang['provider_saved'] = 'Volunteer saved successfully.';
$lang['secretary_saved'] = 'Secretary saved successfully.';
$lang['admin_deleted'] = 'Admin deleted successfully.';
$lang['provider_deleted'] = 'Volunteer deleted successfully.';
$lang['secretary_deleted'] = 'Secretary deleted successfully.';
$lang['service_saved'] = 'Neighbourhood saved successfully.';
$lang['service_category_saved'] = 'Neighbourhood category saved successfully.';
$lang['service_deleted'] = 'Neighbourhood deleted successfully.';
$lang['service_category_deleted'] = 'Neighbourhood category deleted successfully.';
...
$lang['sunday'] = 'Sunday';
$lang['breaks'] = 'Breaks';
$lang['add_breaks_during_each_day'] = 'Add the working breaks during each day. During breaks the volunteer will not accept any appointments.';
$lang['day'] = 'Day';
$lang['days'] = 'Days';
...
$lang['edit_working_plan_hint'] = 'Mark below the days and hours that your company will accept appointments. You will be able to adjust appointments in non-working hours but the customers will not be able to book appointments by themselves in non-working periods. This working plan will be the default for every new volunteer record, but you will be able to change each volunteer\'s plan separately by editing his record. After that you can add break periods.';
$lang['edit_breaks_hint'] = 'Add the working breaks during each day. These breaks will be applied for all new volunteers.';
$lang['book_advance_timeout'] = 'Book Advance Timeout';
$lang['book_advance_timeout_hint'] = 'Define the timeout (in minutes) before the participants can book or re-arrange appointments with the company.';
$lang['timeout_minutes'] = 'Timeout (Minutes)';
$lang['about_app_info'] = 'Easy!Appointments is a highly customizable web application that allows your participants to book appointments with you via the web. Moreover, it provides the ability to sync your data with Google Calendar, so you can use them with other services.';
...
$lang['delete_service'] = 'Delete Neighbourhood';
$lang['delete_category'] = 'Delete Neighbourhood Category';
$lang['delete_provider'] = 'Delete Volunteer';
...
$lang['any_provider'] = 'Any Volunteer';
...
$lang['require_phone_number_hint'] = 'When enabled, participant and users will need to enter the participant\'s phone number when booking an appointment';
...
$lang['overwrite_existing_working_plans'] = 'This will overwrite the existing volunteer working plans, are you sure that you want to continue?';
$lang['working_plans_got_updated'] = 'All the working plans got updated.';
$lang['apply_to_all_providers'] = 'Apply To All Volunteers';
$lang['display_any_provider'] = 'Display Any Volunteer Option';
$lang['display_any_provider_hint'] = 'The booking page will get an additional option that allows participants to book without specifying a volunteer.';
